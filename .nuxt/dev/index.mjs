...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/.nuxt/nuxt-icon-server-bundle.mjs';
import { walkResolver } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online/public"
      ]
    },
    "http": {
      "domains": []
...
const _Qz8aejWMugRy4Ks7P7fEjtMty2MA_zybGUT0lKgmtw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "C:/Users/enzo-sives/Documents/Nueva carpeta/openbook_online";
...
const _lSNgkjHx_0yOn8Sr5OizuwkO5rjakBT3vLK5FcCKIs = (nitroApp) => {
...
const _HuiDX5fNYcr2rKiJJzE8VscdqEvCljDkkyDwojV47Ek = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _Qz8aejWMugRy4Ks7P7fEjtMty2MA_zybGUT0lKgmtw,
_lSNgkjHx_0yOn8Sr5OizuwkO5rjakBT3vLK5FcCKIs,
_HuiDX5fNYcr2rKiJJzE8VscdqEvCljDkkyDwojV47Ek
];
...
const _1GKcwF = eventHandler((event) => {
...
const _rnD32y = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _iaHda5 = eventHandler(async (event) => {
  ...
  return await import('file://C:/Users/enzo-sives/Documents/Nueva%20carpeta/openbook_online/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _MFBrvY = eventHandler(async (event) => {
...
const _s2CuV5 = lazyEventHandler(() => {
...
const _lazy_ZLQZEe = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _1GKcwF, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ZLQZEe, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _rnD32y, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _iaHda5, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _MFBrvY, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _s2CuV5, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_ZLQZEe, lazy: true, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_ZLQZEe, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ZLQZEe, lazy: true, middleware: false, method: undefined }
];
